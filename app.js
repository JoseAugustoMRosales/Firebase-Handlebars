...
const serviceAccount = require('./webii-2b401-firebase-adminsdk-umkit-b4808895f9.json')
...
hb.registerHelper('eq', function(v1, v2){
    return v1 === v2;
})
...
app.get('/editar/:id', function(req, res){
    ...
    db.collection('clientes').doc(id).get().then(
...
app.post('/atualizar', function(req, res){
    ...
    var result = db.collection('clientes').doc(id).update({
        ...
        console.log('Documento atualzado com sucesso!');
